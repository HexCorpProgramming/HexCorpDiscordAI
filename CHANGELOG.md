...
- list of orders was not deserialized properly

## [1.2.0.2]
### Fixed
- AI saves the duration of reported orders correctly.
...
### Fixed
- AI responded to all messages starting with help
- order_reporting does not start multiple progress reporters anymore

## [1.2.0.0]
### Added
- added a `help` command that tells users which command they can use in the current channel

### Changed
- the AI now requires Python version 3.8 or higher
- DroneMode renamed to Speech Optimization
- Added orders reporting module

## [1.1.0.5]
### Fixed
- *somebody* put the blacklisted channels as a list into the list of blacklisted channels
...
- dronemode is not enforced in dev-channels anymore
