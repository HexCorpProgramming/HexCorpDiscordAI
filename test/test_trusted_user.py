...
class TrustedUserTest(unittest.IsolatedAsyncioTestCase):
    ...
    @cog(TrustedUserCog)
    async def asyncSetUp(self, bot: Bot):
        self.bot = bot
        self.cog = bot.get_cog('TrustedUserCog')
        ...
        self.trusted_user_member.bot = False

        # self.context = AsyncMock()
        # self.context.bot = bot
        # self.context.bot.guilds = Mock()
    ...
    async def test_successful_request(self):
        ...
        message.set_drone_members(self.trusted_user_member)
        await self.assert_command_successful(self.bot, message)
    ...
    # async def test_unsuccessful_request_user_is_self(self):
    #     # setup
    ...
    # async def test_unsuccessful_request_user_already_added(self):
    #     # setup
    #     find_user_by_display_name_or_drone_id.return_value = self.trusted_user_member
