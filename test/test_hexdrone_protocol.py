...
from src.ai.hexdrone_protocol import StatusType, get_status_type, build_status_message, optimize_speech
...
class TestHexdroneProtocol(unittest.IsolatedAsyncioTestCase):
    '''
    ...
    @patch('src.ai.hexdrone_protocol.DroneMember')
